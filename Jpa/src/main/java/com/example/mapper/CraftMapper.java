...
public interface CraftMapper extends BaseMapper<Craft> {
    ...
    @Select("<script>" +
            ...
            "</script> ")
    List<Craft> selectAllByIdAndNameAndStatuspage(@Param("name") String name, @Param("status") Integer status, @Param("alimit") Integer alimit, @Param("aoffset") Integer aoffset);
