...
public class GlobalExceptionHandler {
     ...
     * @Author: CoderMast <a href="https://www.codermast.com/">...</a>
     */
    @ExceptionHandler(com.example.execption.CustomException.class)
    public Result<String> CustomExceptionHandler(com.example.execption.CustomException customException) {
